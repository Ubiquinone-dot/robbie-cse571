#!/bin/bash
#SBATCH --job-name=act_so101_2gpu
#SBATCH --output=/net/scratch/jbutch/lerobot/multi_p2/slurm-%j.out
#SBATCH --error=/net/scratch/jbutch/lerobot/multi_p2/slurm-%j.err
...
POLICY_USER="Jbutch"
BASE_OUTPUT_DIR="/net/scratch/jbutch/lerobot/multi_p2"
...
echo "=================================================="
echo "LeRobot Multi-Episode Training (2x L40 GPU)"
echo "=================================================="
...
for NUM_EPISODES in "${EPISODE_COUNTS[@]}"; do
    ...
    accelerate launch \
        ...
        --policy.device=cuda \
        --wandb.enable=true \
        --policy.repo_id=${POLICY_USER}/act_p2_2gpu_ep${NUM_EPISODES}
