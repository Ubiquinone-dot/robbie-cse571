#!/bin/bash
#SBATCH --job-name=smolvla_basket
...
POLICY_USER="Jbutch"
BASE_DIR="/net/scratch/jbutch/lerobot/smolvla_basket"
...
echo "=================================================="
echo "LeRobot SmolVLA Training - place_the_basket (8x L40)"
echo "=================================================="
echo "Dataset:    $DATASET_REPO"
echo "Policy:     smolvla (fine-tuned from lerobot/smolvla_base)"
...
echo ""
echo "=================================================="
echo "SmolVLA training completed!"
echo "=================================================="
